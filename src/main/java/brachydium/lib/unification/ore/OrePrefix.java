...
import static brachydium.lib.unification.ore.OrePrefix.Conditions.*;
...
public class OrePrefix {
    ...
    public static final OrePrefix ore = new OrePrefix("ore", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix oreGranite = new OrePrefix("oreGranite", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix oreDiorite = new OrePrefix("oreDiorite", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix oreAndesite = new OrePrefix("oreAndesite", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix oreBlackgranite = new OrePrefix("oreBlackgranite", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix oreRedgranite = new OrePrefix("oreRedgranite", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix oreMarble = new OrePrefix("oreMarble", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix oreBasalt = new OrePrefix("oreBasalt", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);

    // In case of an Sand-Ores Mod. Ore -> Material is a Oneway Operation!
    public static final OrePrefix oreSand = new OrePrefix("oreSand", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix oreRedSand = new OrePrefix("oreRedSand", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, null);

    // Prefix of the Nether-Ores Mod. Causes Ores to double. Ore -> Material is a Oneway Operation!
    public static final OrePrefix oreNetherrack = new OrePrefix("oreNetherrack", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);
    // In case of an End-Ores Mod. Ore -> Material is a Oneway Operation!
    public static final OrePrefix oreEndstone = new OrePrefix("oreEndstone", -1, null, MaterialIconType.ore, Flags.ENABLE_UNIFICATION, hasOreProperty);

    public static final OrePrefix crushedCentrifuged = new OrePrefix("crushedCentrifuged", -1, null, MaterialIconType.crushedCentrifuged, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix crushedPurified = new OrePrefix("crushedPurified", -1, null, MaterialIconType.crushedPurified, Flags.ENABLE_UNIFICATION, hasOreProperty);
    public static final OrePrefix crushed = new OrePrefix("crushed", -1, null, MaterialIconType.crushed, Flags.ENABLE_UNIFICATION, hasOreProperty, mat -> Collections.singletonList(I18n.format("metaitem.crushed.tooltip.purify")));

    // Introduced by Mekanism
    public static final OrePrefix shard = new OrePrefix("shard", -1, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix clump = new OrePrefix("clump", -1, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix reduced = new OrePrefix("reduced", -1, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix crystalline = new OrePrefix("crystalline", -1, null, null, Flags.ENABLE_UNIFICATION, null);

    public static final OrePrefix cleanGravel = new OrePrefix("cleanGravel", -1, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix dirtyGravel = new OrePrefix("dirtyGravel", -1, null, null, Flags.ENABLE_UNIFICATION, null);

    // A hot Ingot, which has to be cooled down by a Vacuum Freezer.
    public static final OrePrefix ingotHot = new OrePrefix("ingotHot", M, null, MaterialIconType.ingotHot, Flags.ENABLE_UNIFICATION, hasBlastProperty.and(mat -> mat.getProperty(PropertyKey.BLAST).getBlastTemperature() > 1750));
    // A regular Ingot. Introduced by Eloraam
    public static final OrePrefix ingot = new OrePrefix("ingot", M, null, MaterialIconType.ingot, Flags.ENABLE_UNIFICATION, hasIngotProperty);

    // A regular Gem worth one Dust. Introduced by Eloraam
    public static final OrePrefix gem = new OrePrefix("gem", M, null, MaterialIconType.gem, Flags.ENABLE_UNIFICATION, hasGemProperty);
    // A regular Gem worth one small Dust. Introduced by TerraFirmaCraft
    public static final OrePrefix gemChipped = new OrePrefix("gemChipped", M / 4, null, MaterialIconType.gemChipped, Flags.ENABLE_UNIFICATION, hasGemProperty.and(unused -> ConfigHolder.recipes.generateLowQualityGems));
    // A regular Gem worth two small Dusts. Introduced by TerraFirmaCraft
    public static final OrePrefix gemFlawed = new OrePrefix("gemFlawed", M / 2, null, MaterialIconType.gemFlawed, Flags.ENABLE_UNIFICATION, hasGemProperty.and(unused -> ConfigHolder.recipes.generateLowQualityGems));
    // A regular Gem worth two Dusts. Introduced by TerraFirmaCraft
    public static final OrePrefix gemFlawless = new OrePrefix("gemFlawless", M * 2, null, MaterialIconType.gemFlawless, Flags.ENABLE_UNIFICATION, hasGemProperty);
    // A regular Gem worth four Dusts. Introduced by TerraFirmaCraft
    public static final OrePrefix gemExquisite = new OrePrefix("gemExquisite", M * 4, null, MaterialIconType.gemExquisite, Flags.ENABLE_UNIFICATION, hasGemProperty);

    // 1/4th of a Dust.
    public static final OrePrefix dustSmall = new OrePrefix("dustSmall", M / 4, null, MaterialIconType.dustSmall, Flags.ENABLE_UNIFICATION, hasDustProperty);
    // 1/9th of a Dust.
    public static final OrePrefix dustTiny = new OrePrefix("dustTiny", M / 9, null, MaterialIconType.dustTiny, Flags.ENABLE_UNIFICATION, hasDustProperty);
    // Dust with impurities. 1 Unit of Main Material and 1/9 - 1/4 Unit of secondary Material
    public static final OrePrefix dustImpure = new OrePrefix("dustImpure", M, null, MaterialIconType.dustImpure, Flags.ENABLE_UNIFICATION, hasOreProperty, mat -> Collections.singletonList(I18n.format("metaitem.dust.tooltip.purify")));
    // Pure Dust worth of one Ingot or Gem. Introduced by Alblaka.
    public static final OrePrefix dustPure = new OrePrefix("dustPure", M, null, MaterialIconType.dustPure, Flags.ENABLE_UNIFICATION, hasOreProperty, mat -> Collections.singletonList(I18n.format("metaitem.dust.tooltip.purify")));
    public static final OrePrefix dust = new OrePrefix("dust", M, null, MaterialIconType.dust, Flags.ENABLE_UNIFICATION, hasDustProperty);

    // A Nugget. Introduced by Eloraam
    public static final OrePrefix nugget = new OrePrefix("nugget", M / 9, null, MaterialIconType.nugget, Flags.ENABLE_UNIFICATION, hasIngotProperty);

    // 9 Plates combined in one Item.
    public static final OrePrefix plateDense = new OrePrefix("plateDense", M * 9, null, MaterialIconType.plateDense, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_DENSE) && !mat.hasFlag(NO_SMASHING));
    // 2 Plates combined in one Item
    public static final OrePrefix plateDouble = new OrePrefix("plateDouble", M * 2, null, MaterialIconType.plateDouble, Flags.ENABLE_UNIFICATION, hasIngotProperty.and(mat -> mat.hasFlag(GENERATE_PLATE) && !mat.hasFlag(NO_SMASHING)));
    // Regular Plate made of one Ingot/Dust. Introduced by Calclavia
    public static final OrePrefix plate = new OrePrefix("plate", M, null, MaterialIconType.plate, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_PLATE));

    // Round made of 1 Nugget
    public static final OrePrefix round = new OrePrefix("round", M / 9, null, MaterialIconType.round, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_ROUND));
    // Foil made of 1/4 Ingot/Dust.
    public static final OrePrefix foil = new OrePrefix("foil", M / 4, null, MaterialIconType.foil, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_FOIL));

    // Stick made of an Ingot.
    public static final OrePrefix stickLong = new OrePrefix("stickLong", M, null, MaterialIconType.stickLong, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_LONG_ROD));
    // Stick made of half an Ingot. Introduced by Eloraam
    public static final OrePrefix stick = new OrePrefix("stick", M / 2, null, MaterialIconType.stick, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_ROD));

    // consisting out of 1/8 Ingot or 1/4 Stick.
    public static final OrePrefix bolt = new OrePrefix("bolt", M / 8, null, MaterialIconType.bolt, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_BOLT_SCREW));
    // consisting out of 1/9 Ingot.
    public static final OrePrefix screw = new OrePrefix("screw", M / 9, null, MaterialIconType.screw, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_BOLT_SCREW));
    // consisting out of 1/2 Stick.
    public static final OrePrefix ring = new OrePrefix("ring", M / 4, null, MaterialIconType.ring, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_RING));
    // consisting out of 1 Fine Wire.
    public static final OrePrefix springSmall = new OrePrefix("springSmall", M / 4, null, MaterialIconType.springSmall, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_SPRING_SMALL) && !mat.hasFlag(NO_SMASHING));
    // consisting out of 2 Sticks.
    public static final OrePrefix spring = new OrePrefix("spring", M, null, MaterialIconType.spring, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_SPRING) && !mat.hasFlag(NO_SMASHING));
    // consisting out of 1/8 Ingot or 1/4 Wire.
    public static final OrePrefix wireFine = new OrePrefix("wireFine", M / 8, null, MaterialIconType.wireFine, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_FINE_WIRE));
    // consisting out of 4 Plates, 1 Ring and 1 Screw.
    public static final OrePrefix rotor = new OrePrefix("rotor", M * 4, null, MaterialIconType.rotor, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_ROTOR));
    public static final OrePrefix gearSmall = new OrePrefix("gearSmall", M, null, MaterialIconType.gearSmall, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_SMALL_GEAR));
    // Introduced by me because BuildCraft has ruined the gear Prefix...
    public static final OrePrefix gear = new OrePrefix("gear", M * 4, null, MaterialIconType.gear, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_GEAR));
    // 3/4 of a Plate or Gem used to shape a Lens. Normally only used on Transparent Materials.
    public static final OrePrefix lens = new OrePrefix("lens", (M * 3) / 4, null, MaterialIconType.lens, Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_LENS));

    // made of 4 Ingots.
    public static final OrePrefix toolHeadBuzzSaw = new OrePrefix("toolHeadBuzzSaw", M * 4, null, MaterialIconType.toolHeadBuzzSaw, Flags.ENABLE_UNIFICATION, hasNoCraftingToolProperty.and(mat -> mat.hasFlag(GENERATE_PLATE)));
    // made of 1 Ingots.
    public static final OrePrefix toolHeadScrewdriver = new OrePrefix("toolHeadScrewdriver", M, null, MaterialIconType.toolHeadScrewdriver, Flags.ENABLE_UNIFICATION, hasNoCraftingToolProperty.and(mat -> mat.hasFlag(GENERATE_LONG_ROD)));
    // made of 4 Ingots.
    public static final OrePrefix toolHeadDrill = new OrePrefix("toolHeadDrill", M * 4, null, MaterialIconType.toolHeadDrill, Flags.ENABLE_UNIFICATION, hasToolProperty.and(mat -> mat.hasFlag(GENERATE_PLATE)));
    // made of 2 Ingots.
    public static final OrePrefix toolHeadChainsaw = new OrePrefix("toolHeadChainsaw", M * 2, null, MaterialIconType.toolHeadChainsaw, Flags.ENABLE_UNIFICATION, hasNoCraftingToolProperty.and(mat -> mat.hasFlag(GENERATE_PLATE)));
    // made of 4 Ingots.
    public static final OrePrefix toolHeadWrench = new OrePrefix("toolHeadWrench", M * 4, null, MaterialIconType.toolHeadWrench, Flags.ENABLE_UNIFICATION, hasNoCraftingToolProperty.and(mat -> mat.hasFlag(GENERATE_PLATE)));
    // made of 5 Ingots.
    public static final OrePrefix turbineBlade = new OrePrefix("turbineBlade", M * 10, null, MaterialIconType.turbineBlade, Flags.ENABLE_UNIFICATION, hasRotorProperty.and(m -> m.hasFlags(GENERATE_BOLT_SCREW, GENERATE_PLATE) && !m.hasProperty(PropertyKey.GEM)));

    public static final OrePrefix paneGlass = new OrePrefix("paneGlass", -1, MarkerMaterials.Color.Colorless, null, Flags.SELF_REFERENCING, null);
    public static final OrePrefix blockGlass = new OrePrefix("blockGlass", -1, MarkerMaterials.Color.Colorless, null, Flags.SELF_REFERENCING, null);

    // Storage Block consisting out of 9 Ingots/Gems/Dusts. Introduced by CovertJaguar
    public static final OrePrefix block = new OrePrefix("block", M * 9, null, MaterialIconType.block, Flags.ENABLE_UNIFICATION, null);
    ...
    public static final OrePrefix stone = new OrePrefix("stone", -1, Materials.Stone, null, Flags.SELF_REFERENCING, null);

    public static final OrePrefix frameGt = new OrePrefix("frameGt", M * 2, null, null, Flags.ENABLE_UNIFICATION, material -> material.hasFlag(GENERATE_FRAME));

    public static final OrePrefix pipeTinyFluid = new OrePrefix("pipeTinyFluid", M / 2, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeSmallFluid = new OrePrefix("pipeSmallFluid", M, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeNormalFluid = new OrePrefix("pipeNormalFluid", M * 3, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeLargeFluid = new OrePrefix("pipeLargeFluid", M * 6, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeHugeFluid = new OrePrefix("pipeHugeFluid", M * 12, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeQuadrupleFluid = new OrePrefix("pipeQuadrupleFluid", M * 4, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeNonupleFluid = new OrePrefix("pipeNonupleFluid", M * 9, null, null, Flags.ENABLE_UNIFICATION, null);

    public static final OrePrefix pipeTinyItem = new OrePrefix("pipeTinyItem", M / 2, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeSmallItem = new OrePrefix("pipeSmallItem", M, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeNormalItem = new OrePrefix("pipeNormalItem", M * 3, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeLargeItem = new OrePrefix("pipeLargeItem", M * 6, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeHugeItem = new OrePrefix("pipeHugeItem", M * 12, null, null, Flags.ENABLE_UNIFICATION, null);

    public static final OrePrefix pipeSmallRestrictive = new OrePrefix("pipeSmallRestrictive", M, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeNormalRestrictive = new OrePrefix("pipeNormalRestrictive", M * 3, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeLargeRestrictive = new OrePrefix("pipeLargeRestrictive", M * 6, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix pipeHugeRestrictive = new OrePrefix("pipeHugeRestrictive", M * 12, null, null, Flags.ENABLE_UNIFICATION, null);

    public static final OrePrefix wireGtHex = new OrePrefix("wireGtHex", M * 8, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix wireGtOctal = new OrePrefix("wireGtOctal", M * 4, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix wireGtQuadruple = new OrePrefix("wireGtQuadruple", M * 2, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix wireGtDouble = new OrePrefix("wireGtDouble", M, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix wireGtSingle = new OrePrefix("wireGtSingle", M / 2, null, null, Flags.ENABLE_UNIFICATION, null);

    public static final OrePrefix cableGtHex = new OrePrefix("cableGtHex", M * 8, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix cableGtOctal = new OrePrefix("cableGtOctal", M * 4, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix cableGtQuadruple = new OrePrefix("cableGtQuadruple", M * 2, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix cableGtDouble = new OrePrefix("cableGtDouble", M, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix cableGtSingle = new OrePrefix("cableGtSingle", M / 2, null, null, Flags.ENABLE_UNIFICATION, null);
    ...
    // Introduced by Calclavia
    public static final OrePrefix circuit = new OrePrefix("circuit", -1, null, null, Flags.ENABLE_UNIFICATION, null);
    public static final OrePrefix component = new OrePrefix("component", -1, null, null, Flags.ENABLE_UNIFICATION, null);

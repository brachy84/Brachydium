package brachydium.lib.unification.material;

import brachydium.lib.BrachydiumAPI;
import brachydium.lib.util.SmallDigits;
import com.google.common.base.CaseFormat;
import com.google.common.base.Preconditions;
import com.google.common.collect.ImmutableList;
import brachydium.lib.fluids.fluidType.FluidType;
import brachydium.lib.fluids.fluidType.FluidTypes;
import brachydium.lib.unification.Element;
import brachydium.lib.unification.Elements;
import brachydium.lib.unification.material.info.MaterialFlag;
import brachydium.lib.unification.material.info.MaterialFlags;
import brachydium.lib.unification.material.info.MaterialIconSet;
import brachydium.lib.unification.material.properties.*;
...
public class Material implements Comparable<Material> {
    ...
    protected void registerMaterial() {
        verifyMaterial();
        BrachydiumAPI.MATERIALS.register(toString(), this, getId());
    }

    public void addFlags(MaterialFlag... flags) {
        if (BrachydiumAPI.MATERIALS.isFrozen())
    ...
    public Fluid getFluid() {
        ...
        if (fluid == null)
            BrachydiumAPI.LOG.warn("Material {} Fluid was null!", this);
